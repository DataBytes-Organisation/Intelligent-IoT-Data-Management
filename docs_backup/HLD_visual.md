...
![Figure 22.1: System Context Diagram](diagrams/22-1-system-context-diagram.png)
...
![Figure 22.2: Layered Component Diagram (Primary Runtime)](diagrams/22-2-layered-component-diagram-primary-runtime.png)
...
![Figure 22.3: End-to-End Sequence Diagram (Stream Filtering)](diagrams/22-3-end-to-end-sequence-diagram-stream-filtering.png)
...
![Figure 22.4: Data Processing and Insight Flow](diagrams/22-4-data-processing-and-insight-flow.png)
...
![Figure 22.5: Deployment View (Current Ecosystem)](diagrams/22-5-deployment-view-current-ecosystem.png)
...
![Figure 22.6: Monitoring and Operations View](diagrams/22-6-monitoring-and-operations-view.png)
...
![Figure 22.7: Convergence Roadmap Diagram](diagrams/22-7-convergence-roadmap-diagram.png)
